...
<%!
	public static final String STORAGE_INPUT_URL = "pages/back/admin/manage/storage_input.action" ;
%>
<script type="text/javascript" src="js/pages/back/admin/manage/manage_storage_input.js"></script>
	...
	<div class="wrapper">
		...
		<div class="content-wrapper text-left">
				...
				<div class="panel-heading">
					<strong><span class="glyphicon glyphicon-user"></span>&nbsp;商品入库</strong>
				</div>
