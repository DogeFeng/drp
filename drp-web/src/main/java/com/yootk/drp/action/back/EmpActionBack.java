...
public class EmpActionBack extends AbstractAction {
    ...
    public ModuleAndView list() {
        ...
        try {
            mav.add(this.empServiceBack.list(pu.getCurrentPage(), pu.getLineSize(),pu.getColumn(), pu.getKeyword()));
        } catch (Exception e) {
            e.printStackTrace();
        }
        return mav;
    ...
    public ModuleAndView editPre(String mid) {
        ...
        try {
            mav.add(this.empServiceBack.preEdit(mid));
    ...
    public ModuleAndView edit(Member member, MultipartFile pic) {
        ...
        try {
            if (this.empServiceBack.edit(member)) {
    ...
    public ModuleAndView addPre(){
        ...
        try {
            mav.add(this.empServiceBack.preAdd());
        } catch (Exception e) {
            e.printStackTrace();
        }
        return mav;
    ...
    public ModuleAndView add(Member member, MultipartFile pic){
        ...
        try {
            if(this.empServiceBack.add(member)){
